...
class BuildExe:
    def __init__(self):
        # Name of starting .py
        self.script = "windows_server.py"

        # Name of program
        self.project_name = "Boxxy server"
        ...
        # Description
        self.project_description = "Boxxy server, a simple server for a simple multiplayer box game"

        # Icon file (None will use pygame default icon)
        self.icon_file = "icon_server/icon.ico"
